...
from ...models.list_job_status_item import ListJobStatusItem
...
def _get_kwargs(
    ...
    *,
    ...
    status: Union[Unset, list[ListJobStatusItem]] = UNSET,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/services/{service_id}/jobs".format(
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        status (Union[Unset, list[ListJobStatusItem]]):
