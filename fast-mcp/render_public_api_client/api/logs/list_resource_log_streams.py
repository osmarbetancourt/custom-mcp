...
from ...models.list_resource_log_streams_setting_item import (
...
def _get_kwargs(
    *,
    ...
    setting: Union[Unset, list[ListResourceLogStreamsSettingItem]] = UNSET,
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        setting (Union[Unset, list[ListResourceLogStreamsSettingItem]]):
