...
from ...models.add_or_update_secret_file_body import AddOrUpdateSecretFileBody
...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "put",
        "url": "/services/{service_id}/secret-files/{secret_file_name}".format(
...
def _parse_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
    ...
    if response.status_code == 201:
        response_201 = SecretFile.from_dict(response.json())
