...
T = TypeVar("T", bound="AutoscalingCriteriaCpu")


@_attrs_define
class AutoscalingCriteriaCpu:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        autoscaling_criteria_cpu = cls(
            enabled=enabled,
            percentage=percentage,
        )

        autoscaling_criteria_cpu.additional_properties = d
        return autoscaling_criteria_cpu
