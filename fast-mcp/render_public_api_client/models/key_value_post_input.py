...
T = TypeVar("T", bound="KeyValuePOSTInput")
...
class KeyValuePOSTInput:
    ...
    Attributes:
        ...
        owner_id (str): The ID of the owner of the Key Value instance
        plan (KeyValuePlan):
        region (Union[Unset, str]): The region where the Key Value instance is located
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        key_value_post_input.additional_properties = d
        return key_value_post_input
