...
from ..models.postgres_plan import PostgresPlan
from ..models.postgres_suspended import PostgresSuspended
...
class Postgres:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        suspended = PostgresSuspended(d.pop("suspended"))
        ...
        postgres.additional_properties = d
        return postgres
