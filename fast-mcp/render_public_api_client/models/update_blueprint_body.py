...
T = TypeVar("T", bound="UpdateBlueprintBody")


@_attrs_define
class UpdateBlueprintBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        update_blueprint_body = cls(
            name=name,
            auto_sync=auto_sync,
        )

        update_blueprint_body.additional_properties = d
        return update_blueprint_body
