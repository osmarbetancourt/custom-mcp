...
T = TypeVar("T", bound="RecoverPostgresBody")


@_attrs_define
class RecoverPostgresBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        recover_postgres_body.additional_properties = d
        return recover_postgres_body
