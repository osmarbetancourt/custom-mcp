...
T = TypeVar("T", bound="UpdateMaintenanceBody")


@_attrs_define
class UpdateMaintenanceBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        update_maintenance_body = cls(
            scheduled_at=scheduled_at,
        )

        update_maintenance_body.additional_properties = d
        return update_maintenance_body
