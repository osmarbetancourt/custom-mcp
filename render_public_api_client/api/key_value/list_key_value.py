...
from ...models.key_value_with_cursor import KeyValueWithCursor
...
) -> Optional[Union[Error, list["KeyValueWithCursor"]]]:
    if response.status_code == 200:
        response_200 = []
        _response_200 = response.json()
        for response_200_item_data in _response_200:
            response_200_item = KeyValueWithCursor.from_dict(response_200_item_data)
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[Error, list["KeyValueWithCursor"]]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    """List Key Value instances
     ...
     List Key Value instances matching the provided filters. If no filters are provided, all Key Value
...
def sync(
    *,
    ...
    Returns:
        Union[Error, list['KeyValueWithCursor']]
    """
