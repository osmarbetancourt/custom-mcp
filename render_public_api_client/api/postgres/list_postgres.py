...
from ...models.list_postgres_suspended_item import ListPostgresSuspendedItem
from ...models.postgres_with_cursor import PostgresWithCursor
...
def _get_kwargs(
    *,
    ...
    suspended: Union[Unset, list[ListPostgresSuspendedItem]] = UNSET,
    ...
    include_replicas: Union[Unset, bool] = True,
    ...
    params["includeReplicas"] = include_replicas
...
) -> Optional[Union[Error, list["PostgresWithCursor"]]]:
    if response.status_code == 200:
        response_200 = []
        _response_200 = response.json()
        for response_200_item_data in _response_200:
            response_200_item = PostgresWithCursor.from_dict(response_200_item_data)
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[Error, list["PostgresWithCursor"]]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    """List Postgres instances
     ...
     List Postgres instances matching the provided filters. If no filters are provided, all Postgres
    instances are returned.

    Args:
        name (Union[Unset, list[str]]):
        region (Union[Unset, list[Region]]):
        suspended (Union[Unset, list[ListPostgresSuspendedItem]]):
        ...
        include_replicas (Union[Unset, bool]):  Default: True.
...
def sync(
    *,
    ...
    Returns:
        Union[Error, list['PostgresWithCursor']]
    """
