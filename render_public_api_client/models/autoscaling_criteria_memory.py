...
T = TypeVar("T", bound="AutoscalingCriteriaMemory")


@_attrs_define
class AutoscalingCriteriaMemory:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        autoscaling_criteria_memory = cls(
            enabled=enabled,
            percentage=percentage,
        )

        autoscaling_criteria_memory.additional_properties = d
        return autoscaling_criteria_memory
